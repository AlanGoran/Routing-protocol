...
% Check if message number N from the Node is old or new. If it is old then return old but 
% if it new return {new, Updated} where Updated is the updated history.
